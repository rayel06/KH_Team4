	...
	pageEncoding="UTF-8"%>
			<div class="mybox">
				<div class="lecture">
					<h6>강의내역</h6>
					<p>
						<a class="small" href="${contextPath }/student/myPage">구매한 강의</a>
					</p>
					<p>
					...
					<p>
						<a class="small" href="${contextPath }/student/myWish">찜한 강의</a>
					</p>
					<p>
						<a class="small" href="${contextPath }/student/myOrders">구매이력</a>
					</p>
				</div>
				<div class="privacy">
					<h6>회원정보</h6>
